...
body('id')
    ...
    .withMessage('error : user ID should be longer than 8 words, shorter than 20 words'),
body('password')
...
body('username')
    ...
    .withMessage('error : Username must be longer than 1 word, shorter than 10 words'),
async(req, res) => {
